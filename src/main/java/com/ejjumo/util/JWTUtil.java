...
import com.ejjumo.exception.UnAuthorizedException;
...
application.properties 파일에 저장하면 @Value를 사용할 수 있음
=> 현재 클래스가 스프링컨테이너에 컴포넌트(@Component)등록되어 있을때 가능 


# JWT setting
jwt.salt=ureca-screte-key-20240905-ureca-screte-key-20240905-ureca-screte-key-20240905

#1 hour (millis)  => 3600000
...
//	@Value("${jwt.salt}")
	private String salt="ureca-screte-key-20240905-ureca-screte-key-20240905-ureca-screte-key-20240905";

//	@Value("${jwt.access-token.expiretime}")
	private long accessTokenExpireTime=3600000; //1시간

//	@Value("${jwt.refresh-token.expiretime}")
	private long refreshTokenExpireTime=86400000; //1일
