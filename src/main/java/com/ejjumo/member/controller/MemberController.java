package com.ejjumo.member.controller;
...
import com.ejjumo.member.dto.Member;
import com.ejjumo.member.service.MemberService;
import com.ejjumo.util.JWTUtil;
...
//	@PostMapping("/findMember")  //==> /login으로 변경
	@PostMapping("/login") 
	public Member findMember(@RequestBody Member member) throws Exception {
